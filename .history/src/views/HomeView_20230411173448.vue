          ...
          <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
              <div class="col mb-5">
                  <div class="card h-100">
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <router-link :to="{ name:'Product', params: { id: this.$store.state.products[0].id  } }">
              ...
              <div class="col mb-5">
                  <div class="card h-100">
                      ...
                      <!-- Product actions-->
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <router-link :to="{ name:'Product', params: { id: this.$store.state.products[1].id } }">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">View options</a></div>
                        </router-link>
                      </div>
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
              ...
              <div class="col mb-5">
                  <div class="card h-100">
                      ...
                      <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Sale</div>
                      <!-- Product image-->
                      <img class="card-img-top" src="../../public/images/sozai/wshirt.jpg" alt="..." />
                      <!-- Product details-->
                      <div class="card-body p-4">
                          <div class="text-center">
                              <!-- Product name-->
                      ...
                      <!-- Product actions-->
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <router-link :to="{ name:'Product', params: { id: this.$store.state.products[2].id  } }">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">View options</a></div>
                        </router-link>
                    </div>
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent" >
              ...
              <div class="col mb-5">
                  <div class="card h-100">
                      ...
                      <!-- Product actions-->
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <router-link :to="{ name:'Product', params: { id: this.$store.state.products[3].id  } }">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">View options</a></div>
                        </router-link>
                    </div>
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#" @click="addToCart(this.$store.state.products[3])">Add to cart</a></div>
                      </div>
                  </div>
              </div>
              <div class="col mb-5">
                  <div class="card h-100">
                      ...
                      <!-- Product actions-->
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <router-link :to="{ name:'Product', params: { id: this.$store.state.products[4].id  } }">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">View options</a></div>
                        </router-link>
                      </div>
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#" @click="addToCart(this.$store.state.products[4])">Add to cart</a></div>
                      </div>
                  </div>
              </div>
              <div class="col mb-5">
                  <div class="card h-100">
                      ...
                      <!-- Product actions-->
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <router-link :to="{ name:'Product', params: { id: this.$store.state.products[5].id  } }">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">View options</a></div>
                        </router-link>
                      </div>
                      <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#" @click="addToCart(this.$store.state.products[5])">Add to cart</a></div>
                      </div>
                  </div>
              </div>
